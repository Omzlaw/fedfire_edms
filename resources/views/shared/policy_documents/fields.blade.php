...
<div class="form-group">
    <div class="row">
        {!! Form::label('file_number', 'File Number:',['class'=>'col-md-3 col-lg-3 col-12 control-label']) !!}
        <div class="col-md-9 col-lg-9 col-12">
...
{{-- <div class="form-group col-sm-12">
    ...
    <a href="{{ route('shared.policyDocuments.index') }}" class="btn btn-default">Cancel</a>
</div> --}}


@if (isset($policyDocument))

    {!! Form::model($policyDocument, ['id' => 'form', 'route' => ['shared.policyDocuments.update', $policyDocument->id], 'method' => 'patch', 'class' => 'form-horizontal', 'files' => true]) !!}
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                <div class="row">
            ...
            <div class="form-group">
                <div class="row">
                    {!! Form::label('file_number', 'File Number:', ['class' => 'col-md-3 col-lg-3 col-12 control-label']) !!}
                    <div class="col-md-9 col-lg-9 col-12">
                        {!! Form::text('file_number', null, ['class' => 'form-control', 'placeholder' => 'FM1/FFS/01/0001']) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    {!! Form::label('volume', 'Volume:', ['class' => 'col-md-3 col-lg-3 col-12 control-label']) !!}
                    <div class="col-md-9 col-lg-9 col-12">
        ...
        <div class="col-6">
            <div id="dwtcontrolContainer" class="" height="50%" width="50%"></div>
            <div><embed id=" preview" alt="preview" src=""></div>
        </div>
    </div>
...
@else
    {!! Form::open(['id' => 'form', 'route' => 'shared.policyDocuments.store', 'class' => 'form-horizontal', 'files' => true]) !!}
    <div class="row">
        <div class="col-6">
