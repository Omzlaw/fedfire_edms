...
<head>
    ...
    <style>
        #login-bg {
            /* The image used */
            background-image: url("/custom/img/bg6.jpg");
...
<body>
    ...
    <section id="login-bg" class="">
        <div class="row">
            <div class="col-6">
                {{-- <img class="" width="100%" height="100%" src="{{ asset('custom/img/bg6.jpg') }}"> --}}
            </div>
            <div class="col-6">
                <div class="card">
                    <div class="">
                        <form action="{{ route('login') }}" id="authentication" method="post"
                            class="shadow sign_validator"
                            ...
                            <div class="form-group @error('email') is-invalid @enderror"
                                ...
                                <!-- Start: Email--><input class="form-control d-xl-flex justify-content-xl-center"
                                    type="email" data-toggle="tooltip" data-bs-tooltip="" name="email" placeholder="E-mail"
                            ...
                            <div class="form-group">
                                <div class="form-check" style="margin-left: 40px;"><input id="remember"
                                        ...
                                        id="formCheck-1" style="color: rgb(247,249,252);"><label
                                        class="form-check-label d-xl-flex" for="formCheck-1"
                                        style="font-family: 'Source Sans Pro', sans-serif;">Remember me</label>
                                </div>
                            </div>
                        </form>
                    </div>
