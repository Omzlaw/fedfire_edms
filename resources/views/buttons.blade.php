                    ...
                    <div class="card ">
                          <div class="card-body p-20">
                            ...
                            <button type="button" class="btn btn-secondary m-t-10"> secondary</button>
                                ...
                                <div class="col-md-3">
                            <button type="button" class="btn secondary-color-bg m-t-10 "> Primary</button>
                            <div class="row m-l-5 m-t-10">
                                <div class="col-1 no-padding">
                            ...
                            <button type="button" class="btn secondary-color-bg  m-t-10 m-r-30"> Primary</button>
                            ...
                            <div class="row">
                                <div class="col-12 mt-40">
                                    ...
                                    <button type="button" class="btn secondary-color-bg btn-lg  m-t-10 m-r-30"> Primary</button>
                            ...
                            <div class="row mt-40">
                                        ...
                                        <div class="row">
                                            <div class="col-10">
                                                ...
                                                <div class="m-t-10">
                                                    ...
                                                    <button type="button" class="btn secondary-color-bg btn-lg btn-block  m-t-10"> Primary</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-12">
                                    ...
                                    <div class="btn-group btn-group-toggle m-t-10" data-toggle="buttons">
                                        <label class="btn secondary-color-bg active">
                                            <input type="radio" name="options" id="activecheck"  checked> Active
                                        </label>
                                        <label class="btn secondary-color-bg">
                            ...
                            <div class="row mt-40">
                                ...
                                <div class="col-lg-12 col-12">
                                    ...
                                    <button type="button" class="btn secondary-color-bg btn-lg active  m-t-10 m-r-30"> Primary</button>
                            ...
                            <div class="row">
                                <div class="col-lg-12 mt-40">
                                    ...
                                    <button type="button" class="btn btn-round secondary-color-bg btn-lg m-t-10 m-r-30 w-140px">Primary</button>
