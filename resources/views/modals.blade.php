    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6 col-12">
                <div class="card ">
                    <div class="card-header"><h5 class="text-primary my-2">Basic Modal</h5></div>
                    <hr>
            ...
            <div class="col-md-6 col-12">
                <div class="card ">
                    <div class="card-header"><h5 class="text-primary my-2">Scrolling Long Modal</h5></div>
                    <hr>
                    <div class="card-body py-3">
        ...
        <div class="row">
            <div class="col-md-6 col-12">
                <div class="card ">
                    <div class="card-header"><h5 class="text-primary my-2">Vertically Centered Modal</h5></div>
                    <hr>
                    <div class="card-body py-3">
                            ...
                            <div class="modal-dialog modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        A atque cupiditate deserunt eveniet exercitationem ipsa nam nihil nobis numquam,
                                        omnis optio quidem quo rem saepe tempora tempore voluptatem. Magnam, suscipit. Lorem ipsum dolor sit amet,
                                        consectetur adipisicing elit. A ab accusamus assumenda atque cumque delectu.
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <button type="button" class="btn secondary-color-bg">Save changes</button>
            ...
            <div class="col-md-6 col-12">
                <div class="card ">
                    <div class="card-header"><h5 class="text-primary my-2">Vertically Long Modal</h5></div>
                    <hr>
                    <div class="card-body py-3">
                        <p>When modals become too long for the user’s viewport or device, they scroll independent of the page itself.</p>
                    </div>
