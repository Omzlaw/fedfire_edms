...
use App\DataTables\Humanresources\LeaveTypeDataTable;
use App\Http\Requests\Humanresources;
use App\Http\Requests\Humanresources\CreateLeaveTypeRequest;
...
class LeaveTypeController extends AppBaseController
{
    ...
    {
        return $leaveTypeDataTable->render('humanresources.leave_types.index');
    }
    ...
    {
        return view('humanresources.leave_types.create');
    }
    ...
    public function store(CreateLeaveTypeRequest $request)
    {
        ...
        return redirect(route('humanresources.leaveTypes.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('humanresources.leave_types.show')->with('leaveType', $leaveType);
    }
    ...
    public function edit($id)
    {
        ...
        return view('humanresources.leave_types.edit')->with('leaveType', $leaveType);
    }
